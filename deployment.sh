...
nohup java -jar /home/ec2-user/$ART > log.log 2>&1 &; wget -O - --no-check-certificate  http://localhost:8080/employee > /dev/null 2>  /home/ec2-user/response.txt; cat /home/ec2-user/response.txt | grep -F HTTP
